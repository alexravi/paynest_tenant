...
import 'profile_flatmate2_model.dart';
export 'profile_flatmate2_model.dart';
...
class ProfileFlatmate2Widget extends StatefulWidget {
  const ProfileFlatmate2Widget({super.key});

  static String routeName = 'profile_flatmate_2';
  static String routePath = '/profileFlatmate2';

  @override
  State<ProfileFlatmate2Widget> createState() => _ProfileFlatmate2WidgetState();
}

class _ProfileFlatmate2WidgetState extends State<ProfileFlatmate2Widget> {
  late ProfileFlatmate2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileFlatmate2Model());
  }
