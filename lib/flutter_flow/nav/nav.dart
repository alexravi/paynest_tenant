...
class AppStateNotifier extends ChangeNotifier {
  ...
  PaynestAuthUser? initialUser;
  PaynestAuthUser? user;
  ...
  void update(PaynestAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => PaymentRecieptWidget(),
        ),
        FFRoute(
          name: ProfileFlatmateWidget.routeName,
          path: ProfileFlatmateWidget.routePath,
          builder: (context, params) => ProfileFlatmateWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AddFlatmateWidget.routeName,
          path: AddFlatmateWidget.routePath,
          builder: (context, params) => AddFlatmateWidget(),
        ),
        FFRoute(
          name: AddProfileWidget.routeName,
          path: AddProfileWidget.routePath,
